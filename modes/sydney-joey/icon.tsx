...
export default function SydneyJoeyIcon(props: SVGProps<SVGSVGElement>) {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <title id={titleId}>Sydney Joey</title>
      <defs>
        <clipPath id={clipId}>
      ...
      <g transform="translate(82,82)">
        <circle cx="0" cy="0" r="82" fill="#1E88E5" />
        <ellipse
          cx="-27"
          cy="-44"
          rx="9"
        ...
        <ellipse
          ...
          transform="rotate(28,27,-44)"
        />
        <ellipse cx="0" cy="42" rx="26" ry="22" fill="#154360" />
        <circle cx="0" cy="-10" r="32" fill="#154360" />
        <ellipse cx="0" cy="14" rx="13" ry="12" fill="#154360" />
        <circle cx="-27" cy="34" r="8" fill="#154360" />
        <circle cx="27" cy="34" r="8" fill="#154360" />
        <path
