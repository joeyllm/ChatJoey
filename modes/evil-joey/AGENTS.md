...
Warm crimson/red accent (`#c0392b` / `#8e2a20`) instead of Little Joey's
...
- `icon.tsx` — the horned badge. Reuses Little Joey's kangaroo geometry,
...
- `mascot.tsx` / `mascot.module.css` — its own independent copy of the
  ...
  mother). Self-contained here; doesn't share code with Little Joey's mascot.
